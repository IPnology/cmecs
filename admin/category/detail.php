...
<div class="wrap">	
	...
	<button class="btn-cdelete" onClick="location.href='process.php?action=delete&id=<?=$row['Id']?>'">Delete</button>
	<button class="btn-cupdate" onClick="location.href='?view=update&id=<?=$row['Id']?>'">Update</button>
	</div>